...
ValueShuffle\cite{c19} is an extension of CoinShuffle++ which is compatible with confidential transactions. 

\todo{why we've chosen ValueShuffle and what is our contribution}

\todo{have to edit heavily all sections below}
...
\section{Transaction Processing}\label{tx_processing}
