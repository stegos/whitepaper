...
Data UTXO structure is the same as a structure of a monetary UTXO explained in Section \ref{utxo}. The difference is in the values of $Bp$, $TTL$, $Size_{data}$ and $E_B$ slots:
