...
\chapter{Team and Token Distribution}\label{app:team-and-tokens}
...
\subsection{Joel Reymont CEO, The Buck Stops With Me!}
...
\subsection{Vladimir Lebedev VP of Engineering}
...
\subsection{David McClain, PhD Chief Rocket Scientist}
...
\subsection{Roman Tsisyk, Core Blockchain Team Lead}
...
\subsection{Eugene Chupriyanov Site Reliability Engineer}
...
\def\angle{0}
\def\radius{3}
\def\cyclelist{{"orange","blue","red","green","yellow","purple"}}
\newcount\cyclecount \cyclecount=-1
\newcount\ind \ind=-1
\begin{tikzpicture}[nodes = {font=\sffamily}]
  \foreach \percent/\name in {
      51.25/Proportion of Token Sale,
      16.75/Development,
...
\caption{Token allocation}\label{fig:token-allocation}
\end{figure}

\centering
\begin{itemize}
	\item[51.25\%] Sold to the public
	\item[16.75\%] Development
	\item[10\%] Marketing \& ecosystem
	\item[10\%] Reserve
	\item[10\%] Team
	\item[2\%] Advisors and key backers
\end{itemize}
