...
All amounts in Stegos are hidden using cryptographic commitments and zero-know\-ledge proofs. Validator stakes and transaction fees are the only exception, since these must be visible for blockchain validation to work. 
