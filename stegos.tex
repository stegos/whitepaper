...
The Stegos mobile app is the portal into the ecosystem and a showcase of the potential of our platform. The app integrates the wallet with a secure environment for running privacy-focused applications, the Stegos App Store, as well as group chat and marketplaces.

In addition to standard block rewards, Stegos implements unique a Jackpot feature. A portion of the reward from each block is added to the jackpot, which continues to grow until a winner is selected in an ongoing cryptographic lottery based on verifiable distributed randomness. 
...
\todo[inline]{Describe the red envelopes}
...
\todo[inline]{Describe the need for identity and associated privacy tradeoffs}
