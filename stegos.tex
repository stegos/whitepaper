...
\todo[inline]{Expand on the blocks}
%% Microblocks are signed by the current leader and the leader gets changed for each microblock.
%% We have no transactions in the block
...
\section{Selecting the leader}
\todo[inline]{Briefly explain that validators are selected based on their stakes and that the draw is a stake-weighted lottery}
...
\todo[inline]{Rewrite leader election based on Albatross}
