...
\edef\TotalAmount{\pgfmathresult}
...
% Seed percentage for sale
\pgfmathparse{\SeedTokens / \TokensForSale}
\edef\SeedPctSale{\pgfmathresult}

% Round 1 percentage for sale
\pgfmathparse{\ROneTokens / \TokensForSale}
\edef\ROnePctSale{\pgfmathresult}

% Round 2 percentage for sale
\pgfmathparse{\RTwoTokens / \TokensForSale}
\edef\RTwoPctSale{\pgfmathresult}

% Total percentage for sale
\pgfmathparse{\SeedPctSale + \ROnePctSale + \RTwoPctSale}
...
\centering
	...
	\midrule[2pt]
	Seed & \pAmt{\SeedTokens} & \pPrice{\SeedPrice} & \pPct{\SeedAlloc} & \pPct{\SeedPctSale} & \$\pAmt{\SeedAmt} & \pPct{\SeedPctRaise} \\
	Round 1 & \pAmt{\ROneTokens} & \pPrice{\ROnePrice} & \pPct{\ROneAlloc} & \pPct{\ROnePctSale} & \$\pAmt{\ROneAmt} & \pPct{\ROnePctRaise} \\
	Round 2 & \pAmt{\RTwoTokens} & \pPrice{\RTwoPrice} & \pPct{\RTwoAlloc} & \pPct{\RTwoPctSale} & \$\pAmt{\RTwoAmt} & \pPct{\RTwoPctRaise} \\
	\bottomrule[2pt]
	Total & \pAmt{\TotalTokens} & {} & \pPct{\TotalAlloc} & \pPct{\TotalPctSale} & \$\pAmt{\TotalAmt} & \pPct{\TotalPctRaise} 
	\end{tabular}
