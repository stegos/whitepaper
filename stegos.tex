...
Stegos builds on top of private payments, fast messages, chat and the TAC\ref{TAC} to deliver private marketplaces where items can be sold anonymously and privately. Stegos will release a separate mobile as the marketplaces interface. 
...
\chapter{Validation of Blocks and Transactions}\label{app:validaton}
...
\section{Pruning of used and expired data}
